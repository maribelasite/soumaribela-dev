...
export default function Header() {
  ...
  return (
    <header
      ...
      style={{
        backgroundColor: "var(--color-accent)", // #9FB7B5
        borderColor:
          "color-mix(in srgb, var(--color-accent-hover) 22%, transparent)", // leve nuance rosa na borda
      }}
    >
      {/* MAIN HEADER */}
        ...
        <div className="h-[88px] flex items-center justify-between gap-4">
          ...
          <div className="hidden lg:flex items-center gap-5">
            ...
            >
              ...
              {totalItems > 0 && (
                <span
                  ...
                  style={{
                    backgroundColor: "var(--color-accent-light)", // rosa claro
            ...
            <a
              ...
              style={{
                backgroundColor: "var(--color-success)", // rosa
                color: "var(--color-text-light)",
                fontFamily: "var(--font-heading)",
              }}
            >
